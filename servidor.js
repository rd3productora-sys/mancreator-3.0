...
// Inicialización limpia utilizando la variable estándar del SDK
...
app.post('/api/chat', async (req, res) => {
    try {
        ...
        // Usamos el alias universal oficial que no genera errores de versión 404
        ...
        res.status(500).json({ reply: "Error al conectar con la IA: " + error.message });
    }
});
